...
\item
 \textbf{Tučná internetová aplikácia \ref{21_ri}.} Aplikácie tohto typu sú vyvíjané tak, aby podporovali viacero platforiem a prehliadačov tak, že zobrazujú multimédia alebo iný grafický obsah. Tučné internetové aplikácie bežia v prehliadači, čím sú obmedzený pristupovať k niektorým zdrojom klienta. \\
Výhody: 
 \begin{itemize}
...
Na zváženie: 
 ...
 \end{itemize} 
  ...
  \item
  \textbf{Webová aplikácia \ref{23_web}.} Aplikácie tohoto typu zvyčajne podporujú scenáre s pripojením, podporujú viacero prehliadačov, ktoré bežia na rôznych operačných systémoch.\\
Výhody: 
 \begin{itemize}
...
\end{itemize}
\subsubsection{Servisný aplikácia}
TODO: soap rest point to point (500)
