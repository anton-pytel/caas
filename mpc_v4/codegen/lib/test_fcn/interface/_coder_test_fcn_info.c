...
/* Include Files */
#include "_coder_test_fcn_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  mxSetFieldByNumber(xEntryPoints, 0, 0, mxCreateString("test_fcn"));
...
/*
 * File trailer for _coder_test_fcn_info.c
 *
 * [EOF]
 */
